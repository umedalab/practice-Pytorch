...
def main(args):
    ...
    data_loader = CustomPoseDataLoader(observed_length=expected_observed_length, data_set_path='data',
                                       fname_bodydescriptor='connectivityCOCO14.txt', out_item_mode=0)#connectivityCOCO18
    #data_loader.read_data_pose_from_measurementpy('datatraining/observation/observation_MeasurementPy_datastanding.txt',
    #                                              label_id=0)
    #data_loader.read_data_pose_from_measurementpy('datatraining/observation/observation_MeasurementPy_datasitting.txt',
    #                                              label_id=2)
